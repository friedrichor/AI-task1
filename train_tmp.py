...
from utils import read_data, create_lr_scheduler, get_params_groups, train_one_epoch, evaluate
import params
from model_convnext import convnext_large as create_model  # 更改预训练模型时更改import内容
from models import inception_v3, efficientnet
...
def main(args):
    ...
    # model = create_model(num_classes=params.num_classes).to(device)
    #
    # if args.weights != "":
    ...
    model = inception_v3(params.num_classes).to(device)
    # model = efficientnet(params.num_classes).to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str,
                        default='/content/drive/MyDrive/torch_convnext/convnext_large_22k_1k_384.pth',
