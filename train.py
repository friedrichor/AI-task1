...
def main(args):
    ...
    # convnext
    model = convnext(params.num_classes, args.weights, args.freeze_layers).to(device)
    # inception_v3
    # model = inception_v3(params.num_classes).to(device)
    # efficientnet
    # model = inception_v3(params.num_classes).to(device)
    # densenet
    # model = densenet(params.num_classes).to(device)
    # resnet
    # model = resnet(params.num_classes).to(device)
