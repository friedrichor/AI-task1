...
def convnext(out_channel: int = 4, weights: str = '', freeze_layers: bool = False):
...
def inception_v3(out_channel: int = 4):
...
def efficientnet(outchannel: int = 4):
...
def densenet(out_channel: int = 4):
...
def vit(out_channel: int = 4):
    model = models.vit_l_32(True)
...
class MixModel1(nn.Module):
    def __init__(self, weights: str = '', freeze_layers: bool = False, num_classes: int = 4):
        super(MixModel1, self).__init__()
        self.model1 = convnext(num_classes, weights, freeze_layers)
...
class MixModel3(nn.Module):
    def __init__(self, weights: str = '', freeze_layers: bool = False, num_classes: int = 4):
        ...
        self.model1 = convnext(256, weights, freeze_layers)
