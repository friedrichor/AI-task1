...
from utils import k_fold_read_split_data, split_train_val, create_lr_scheduler, get_params_groups, train_one_epoch, evaluate
import params
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str,
                        default='/content/drive/MyDrive/torch_convnext/convnext_large_1k_224_ema.pth',
